...
Lite.dialog_close_on_mouse_leave = false; // [false on mobile] better true if not touch device;
...
Lite.search_hide_on_mouse_leave = false; // [false on mobile] better true if not touch device;
...
Lite.pointerevents_method = "pointer"; // "mouse"|"pointer" use mouse for retrocompatibility issues? (none found @ now)
...
Lite.two_fingers_opens_menu = true;

Lite.actionHistory_enabled = false; // [true!] cntrlZ, cntrlY
