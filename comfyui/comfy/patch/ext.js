"use strict";
import { app as r } from "../comfy/scripts/app.js";
import { ComfyWidgets as p } from "../comfy/scripts/widgets.js";
const b = (n, c) => {
    const s = { "": { options: [] } };
    for (const e of c)
      if (typeof e == "string")
          ...
          Object.defineProperty(i.widget, "value", {
            get() {
              if (i.widget) {
                ...
                if (
                  t.includes("drawNodeWidgets") ||
                  t.includes("saveImageExtraOutput")
                ) {
                  const o = l || a[0]?.name;
                  if (typeof o == "string")
