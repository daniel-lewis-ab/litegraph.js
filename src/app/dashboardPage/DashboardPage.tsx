  ...
  return (
    <div className="flex w-full items-center justify-center">
      <div className="w-[34%] *:mb-3">
        <button className="flex w-full flex-row items-center rounded-2xl border border-[#313155] px-6 py-4">
        ...
        <button className="!mb-0 flex w-full flex-row items-center rounded-2xl border border-[#313155] px-6 py-4">
          <Icon size={20} icon={faPlus} className="rounded-full bg-surface-100 p-[12px]" />
          <div className="flex flex-col items-start justify-start pl-2.5">
