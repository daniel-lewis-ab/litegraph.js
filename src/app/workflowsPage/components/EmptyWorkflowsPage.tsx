...
export const EmptyWorkflowsPage = () => (
  <div className="flex w-full items-center justify-center">
    <div className="w-[34%] *:mb-3">
      <Link
        className="flex w-full flex-row items-center rounded-3xl border border-border-default px-6 py-4"
      ...
      <button className="flex w-full flex-row items-center rounded-3xl border border-border-default px-6 py-4">
