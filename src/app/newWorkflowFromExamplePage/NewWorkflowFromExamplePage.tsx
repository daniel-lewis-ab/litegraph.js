...
type NewWorkflowFromExamplePageProps = {
  onSubmit(data: NewWorkflowFormData): Promise<Workflow>;
  content: string;
  name: string;
};

export const NewWorkflowFromExamplePage = ({ onSubmit, name, content }: NewWorkflowFromExamplePageProps) => {
  ...
  return (
    <div className="flex h-full w-full items-center justify-center p-6">
      ...
      >
        ...
        {content && <input type="hidden" value={JSON.stringify(content)} {...register('content')} />}
        <Input
          variant="secondary"
